...
const description = "Sign in to your VoiceQuote AI workspace to create and manage voice-generated quotations.";
...
function LoginPage() {
  ...
  // Placeholder auth — connect to your authentication provider here.
